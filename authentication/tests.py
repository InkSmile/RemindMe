...
class TestObtainJSONWebTokenView(BaseAPITest):
    ...
    def test_auth(self):
        ...
        resp = self.client.post(reverse('v1:authentication:obtain'), data=data)
...
class TestVerifyJSONWebTokenView(BaseAPITest):
    ...
    def test_token_is_valid(self):
        ...
        resp = self.client.post(reverse('v1:authentication:verify'), data=data)
...
class TestRefreshJSONWebTokenView(BaseAPITest):
    ...
    def test_get_access_token(self):
        ...
        resp = self.client.post(reverse('v1:authentication:refresh'), data=data)
        self.assertIn('access', resp.data)
...
class TestActivateUserView(BaseAPITest):
    ...
    def test_user_activation(self):
        ...
        data = {'token': token}
        resp = self.client.post(reverse('v1:authentication:activate'), data=data)
